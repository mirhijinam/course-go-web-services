...
func request_AuthChecker_Check_0(ctx context.Context, marshaler runtime.Marshaler, client AuthCheckerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterAuthCheckerHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterAuthCheckerHandler(ctx, mux, conn)
}

// RegisterAuthCheckerHandler registers the http handlers for service AuthChecker to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterAuthCheckerHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
...
func RegisterAuthCheckerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthCheckerClient) error {
	...
	mux.Handle("POST", pattern_AuthChecker_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthChecker_Create_0(rctx, inboundMarshaler, client, req, pathParams)
	...
	mux.Handle("GET", pattern_AuthChecker_Check_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthChecker_Check_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_AuthChecker_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthChecker_Delete_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_AuthChecker_Create_0 = runtime.ForwardResponseMessage

	forward_AuthChecker_Check_0 = runtime.ForwardResponseMessage

	forward_AuthChecker_Delete_0 = runtime.ForwardResponseMessage
)
